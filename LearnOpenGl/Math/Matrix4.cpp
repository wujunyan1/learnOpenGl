...
/*
	...
	void Matrix4::TransformVec2(Vector2& outVec, const Vector2& v, const Matrix4& matrix)
	{
#if LORD_MODE == LORD_MODE_DEBUG
		++Matrix4::OP_COUNT;
#endif
		Real x = v.x * matrix.m00 + v.y * matrix.m10 + matrix.m30;
		Real y = v.x * matrix.m01 + v.y * matrix.m11 + matrix.m31;
		outVec.set(x, y);
	}
