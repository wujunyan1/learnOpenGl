...
#ifndef __LORD_MAT4_H__
#define __LORD_MAT4_H__
...
namespace LORD
{
	...
	public:
		...
		{ 
			ADD_MATH_OP_COUNT
			LordAssertX(i>=0 && i<4, "Access out of bounds");
			LordAssertX(j>=0 && j<4, "Access out of bounds");
			return getRow(i)[j];
		}
		...
		inline void joint(const Matrix4& rhs)
		{
			ADD_MATH_OP_COUNT
			Matrix4 result;

			result.m00 = rhs.m00 * m00 + rhs.m01 * m10 + rhs.m02 * m20 + rhs.m03 * m30;
			result.m01 = rhs.m00 * m01 + rhs.m01 * m11 + rhs.m02 * m21 + rhs.m03 * m31;
			result.m02 = rhs.m00 * m02 + rhs.m01 * m12 + rhs.m02 * m22 + rhs.m03 * m32;
			result.m03 = rhs.m00 * m03 + rhs.m01 * m13 + rhs.m02 * m23 + rhs.m03 * m33;

			result.m10 = rhs.m10 * m00 + rhs.m11 * m10 + rhs.m12 * m20 + rhs.m13 * m30;
			result.m11 = rhs.m10 * m01 + rhs.m11 * m11 + rhs.m12 * m21 + rhs.m13 * m31;
			result.m12 = rhs.m10 * m02 + rhs.m11 * m12 + rhs.m12 * m22 + rhs.m13 * m32;
			result.m13 = rhs.m10 * m03 + rhs.m11 * m13 + rhs.m12 * m23 + rhs.m13 * m33;

			result.m20 = rhs.m20 * m00 + rhs.m21 * m10 + rhs.m22 * m20 + rhs.m23 * m30;
			result.m21 = rhs.m20 * m01 + rhs.m21 * m11 + rhs.m22 * m21 + rhs.m23 * m31;
			result.m22 = rhs.m20 * m02 + rhs.m21 * m12 + rhs.m22 * m22 + rhs.m23 * m32;
			result.m23 = rhs.m20 * m03 + rhs.m21 * m13 + rhs.m22 * m23 + rhs.m23 * m33;

			result.m30 = rhs.m30 * m00 + rhs.m31 * m10 + rhs.m32 * m20 + rhs.m33 * m30;
			result.m31 = rhs.m30 * m01 + rhs.m31 * m11 + rhs.m32 * m21 + rhs.m33 * m31;
			result.m32 = rhs.m30 * m02 + rhs.m31 * m12 + rhs.m32 * m22 + rhs.m33 * m32;
			result.m33 = rhs.m30 * m03 + rhs.m31 * m13 + rhs.m32 * m23 + rhs.m33 * m33;
		...
		{
			ADD_MATH_OP_COUNT
			LordAssertX(row >= 0 && row < 4, "Access out of bounds");
			Real* p = m + row;
			p[0] = vec.x; 
			p[1] = vec.y;
			p[2] = vec.z;
		...
		inline void setColumn(int column, const Vector4& vec)
		{
			ADD_MATH_OP_COUNT
			LordAssertX(column >= 0 && column < 4, "Access out of bounds");
			Real* p = m + column;
			p[0] = vec.x; 
			p[4] = vec.y; 
			p[8] = vec.z; 
	...
	public:
		...
		static void		TransformVec2(Vector2 &outVec, const Vector2 &v, const Matrix4 &matrix);
