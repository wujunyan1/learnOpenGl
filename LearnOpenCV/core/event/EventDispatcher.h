...
namespace Core
{
    ...
    */
    ...
    public:
         ...
         */
        void addEventListenerWithSceneGraphPriority(EventListener* listener, TreeNode* node);
         ...
         */
        void removeEventListenersForTarget(TreeNode* target, bool recursive = false);
         ...
         */
        void pauseEventListenersForTarget(TreeNode* target, bool recursive = false);
         ...
         */
        void resumeEventListenersForTarget(TreeNode* target, bool recursive = false);
         ...
         */
        void debugCheckTreeNodeHasNoEventListenersOnDestruction(TreeNode* node);
    ...
    protected:
        ...
        void setDirtyForTreeNode(TreeNode* node);
        ...
        public:
            ...
            size_t getGt0Index() const { return _gt0Index; }
            void setGt0Index(size_t index) { _gt0Index = index; }
        private:
        ...
        void sortEventListenersOfSceneGraphPriority(const EventListener::ListenerID& listenerID, TreeNode* rootTreeNode);
        ...
        void associateTreeNodeAndEventListener(TreeNode* node, EventListener* listener);

        /** Dissociates node with event listener */
        void dissociateTreeNodeAndEventListener(TreeNode* node, EventListener* listener);
        ...
        void visitTarget(TreeNode* node, bool isRootTreeNode);
        ...
        std::unordered_map<TreeNode*, std::vector<EventListener*>*> _nodeListenersMap;

        /** The map of node and its event priority */
        std::unordered_map<TreeNode*, int> _nodePriorityMap;

        /** key: Global Z Order, value: Sorted TreeNodes */
        std::unordered_map<float, std::vector<TreeNode*>> _globalZOrderTreeNodeMap;
        ...
        std::set<TreeNode*> _dirtyTreeNodes;
