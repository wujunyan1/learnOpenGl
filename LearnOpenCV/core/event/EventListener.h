...
namespace Core
{
    ...
    protected:
         ...
         *        2) In `TreeNode`'s onEnter and onExit, the `paused state` of the listeners which associated with that node will be automatically updated.
         */
        ...
        TreeNode* _node;            // scene graph based priority
