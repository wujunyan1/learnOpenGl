...
using LogWriter = std::function<void(const char*)>;
...
public:
	...
	virtual void setClientMode(bool isClient) = 0;

	virtual void setLogWriter(LogWriter func) = 0;

	virtual std::pair<int, int> getPacketCountStatics(const RakNet::SystemAddress& addr) = 0;
	virtual int getBlackListCount() = 0;
